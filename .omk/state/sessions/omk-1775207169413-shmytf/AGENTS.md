...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omk-1775207169413-shmytf | 2026-04-03T09:06:09.434Z

**Codebase Map:**
  src/: index
  src/agents/: definitions.test, native-config.test, definitions, native-config
  src/autoresearch/: contracts.test, runtime-parity-extra.test, runtime.test, contracts, runtime
  src/catalog/: generator.test, schema.test, reader, schema
  src/cli/: agents-init.test, agents.test, ask.test, autoresearch-guided.test, autoresearch.test, catalog-contract.test, cleanup.test, doctor-invalid-config.test, doctor-team.test, doctor-warning-copy.test
  src/compat/: doctor-contract.test, rust-runtime-compat.test
  src/config/: generator-idempotent.test, generator-notify.test, mcp-registry.test, models.test, generator, mcp-registry, models
  src/hooks/: agents-overlay.test, anti-slop-workflow.test, clawhip-event-contract.test, codebase-map.test, consensus-execution-handoff.test, deep-interview-contract.test, explore-routing.test, explore-sparkshell-guidance-contract.test, keyword-detector.test, notify-fallback-watcher.test
  src/hud/: authority.test, colors.test, hud-tmux-injection....

**Explore Command Preference:** enabled via `USE_OMK_EXPLORE_CMD` (default-on; opt out with `0`, `false`, `no`, or `off`)
