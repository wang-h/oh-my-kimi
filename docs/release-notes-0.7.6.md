...
- Skills canonical OMK path normalization.
...
| `node bin/omk.js --help` | 0 | CLI usage rendered |
| `node bin/omk.js doctor` | 0 | `Results: 9 passed, 0 warnings, 0 failed` |
| `node bin/omk.js version` | 0 | `oh-my-codex v0.7.6` |
| `node bin/omk.js status` | 0 | mode status rendered |
| `node bin/omk.js setup --dry-run` | 0 | dry-run setup completed |
| `node bin/omk.js cancel` | 0 | cancel command completed |
...
- `2026-03-02 e0c5974 fix(skills): normalize forked OMC references to OMK canonical paths`
