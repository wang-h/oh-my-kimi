...
OMX_TEAM_WORKER_CLI=codex   # forcer les workers Kimi Code CLI
...
- **[Référence CLI](https://github.com/wang-h/oh-my-kimi#command-reference)** — Toutes les commandes `omx`, flags et outils
